...
def rotate_around(img, pivot, angle):

    rotated = rotate(img, angle)

    #Rotate a point counterclockwise by a given angle around a given origin.
    #The angle should be given in radians. # todo use this to rotate origin of img slice around pivot point?
    ox, oy = pivot
    px, py = point
